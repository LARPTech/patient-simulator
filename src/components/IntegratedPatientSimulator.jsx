...
const IntegratedPatientSimulator = () => {
  ...
  useEffect(() => {
    // В реальном приложении здесь была бы инициализация физиологической модели
    ...
    const simulatePhysiologicalModel = {
      ...
      applyMedication(medication, dose = 1.0) {
        ...
        switch(medication) {
          ...
          case 'propofol':
            this.state.hr -= 15;
            this.state.systolic -= 25;
            this.state.diastolic -= 10;
            this.state.rr -= 4;
            break;
          case 'midazolam':
            this.state.hr -= 10;
            this.state.systolic -= 15;
            this.state.diastolic -= 8;
            this.state.rr -= 3;
            break;
          case 'fentanyl':
            this.state.hr -= 8;
            this.state.systolic -= 10;
            this.state.diastolic -= 5;
            this.state.rr -= 5;
            break;
          default:
            break;
